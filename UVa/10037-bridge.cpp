...
int main()
{
    ...
    while (casos--)
    {
        ...
        // Existem dois métodos para se atravessar os mais lentos (l1 e l2) e
        // voltar com os dois mais rápidos (r1 e r2) para repetir o processo.
        //  Modo 1.
        //          -> r1 + l1
        //          <- r1
        //          -> r1 + l2
        //          <- r1
        //          Custo: 2*r1 + l1 + l2 em cada passo
        //  Modo 2.
        //          -> r1 + r2
        //          <- r1
        //          -> l1 + l2
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    cout << saida.at(i-2) << endl
                         << saida.at(i-1) << " " << saida.at(i) << endl;
                }
            }
        }
